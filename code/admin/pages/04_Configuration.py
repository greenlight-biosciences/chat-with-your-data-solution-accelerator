...
st.set_page_config(page_title="Configure Prompts", page_icon=getImageFromURL(os.getenv('FAVICON_URL')), layout="wide", menu_items=None)
...
input_password = st.text_input("Enter password to view this page:", type="password")

# Check if the entered password matches the password from .env file
if input_password == os.getenv('CONFIG_PASSWORD'):
    st.success("Access granted!")
    # Display additional content from the configuration page here
